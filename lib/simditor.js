...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ["jquery","simple-module","simple-hotkeys","r-simple-uploader"], function ($, SimpleModule, simpleHotkeys, simpleUploader) {
    ...
    // like Node.
    module.exports = factory(require("jquery"),require("simple-module"),require("simple-hotkeys"),require("r-simple-uploader"));
  } else {
...
Simditor = (function(superClass) {
  ...
  Simditor.prototype._init = function() {
    ...
    if (this.opts.upload && simpleUploader) {
      ...
      this.uploader = new simpleUploader(uploadOpts);
    }
  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    this.editor.uploader.on('uploadsuccess', (function(_this) {
      return function(e, file, result) {
        var $img, imgRemove, img_path, msg;
        if (!file.inline) {
          return;
        }
        $img = file.img;
        ...
        if (result.success === false) {
          ...
          imgRemove = !_this.editor.uploader.opts.base64;
        } else {
          img_path = result.file_path ? result.file_path : file.file_path;
        }
        if (imgRemove) {
          _this.editor.body.remove($img);
        } else {
    ...
    return this.editor.uploader.on('uploaderror', (function(_this) {
      return function(e, file, xhr) {
        ...
        if (_this.editor.uploader.opts.base64) {
